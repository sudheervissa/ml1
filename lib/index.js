 ...
 * @namespace faker
 */
 var College = function Faker (opts) {
  ...
  var _definitions = {
    ...
    "college": ["college", "university", "model1", "type", "reasearch"],
    "title": "",
    "separator": ""
  };
...
College.prototype.setLocale = function (locale) {
  this.locale = locale;
}

College.prototype.seed = function(value) {
  var Random = require('./random');
